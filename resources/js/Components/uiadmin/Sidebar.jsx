...
import { Separator } from "@/Components/uiadmin/Separator";
import { Sheet, SheetContent } from "@/Components/uiadmin/Sheet";
import { Skeleton } from "@/Components/uiadmin/Skeleton";
import {
    Tooltip,
    TooltipContent,
    TooltipProvider,
    TooltipTrigger,
} from "@/Components/uiadmin/Tooltip";
    ...
    ({ className, onClick, ...props }, ref) => {
        ...
        return (
            <Button
                ...
                variant="ghost"
                size="icon"
                className={cn("relative top-0 left-0 h-7 w-7", className)}
                onClick={(event) => {
                    onClick?.(event);
                    toggleSidebar();
                }}
